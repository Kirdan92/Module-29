...
mongoose.connect('mongodb://mo1135_test1135:YghEH0MhExkq7TK7nNxT@mongo19.mydevil.net/mo1135_test1135', {
    useMongoClient: true
});
...
const updateUsername = function() {
    ...
    return User.findOneAndUpdate({ username: 'Benny_the_boy' }, { username: 'Benny_the_man' }, { new: true }, function(err, user) {
        ...
        console.log('Nazwa uzytkownika po aktualizacji to Benny_the_man' );
    })
}
